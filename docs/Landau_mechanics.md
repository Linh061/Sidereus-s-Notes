...
Because $u = \frac{\partial L}{\partial \dot{q}}, du = \frac{d}{dt} \left( \frac{\partial L}{\partial \dot{q}} \right) dt$; $dv = \delta \dot{q}dt = d\delta q, v = \delta q$. After substitution, we obtain $\left. \frac{\partial L}{\partial \dot{q}}\delta q \right|_{t_1}^{t_2} - \int_{t_1}^{t_2} \delta q \frac{d}{dt} \left( \frac{\partial L}{\partial \dot{q}} \right) dt$. And since $\delta q(t_1) = \delta q(t_2) = 0$, the first term vanishes, so for all values of $\delta q$ we obtain:  
